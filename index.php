...
<nav class="navbar navbar-dark navbar-expand-md navigation-clean-search">
    <div class="container">
        ...
        <a class="navbar-brand" href="#">Sistema de Controle<span class="badge badge-success"></span></a>
            ...
            <div class="modal-content">
                ...
                <div class="container-hero" >
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-4 plan price default" onclick="abrirUrl('includes/manual.html');">
                        ...
                        <div class="col-sm-12 col-md-4 plan price default" onclick="abrirUrl('assets/img/I laudo caracterizador PCD.pdf');">
